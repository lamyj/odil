...
public:
    ...
    public:
         ...
         */
        std::vector<ProtocolDataUnitItem> const & as_items() const;
         ...
         * If the field does not contain items, a dcmtkpp::Exception is raised.
         */
        std::vector<ProtocolDataUnitItem> & as_items();
    ...
    private:
        ...
        uint32_t _uint32;
        std::string _string;
        std::vector<ProtocolDataUnitItem> _items;
    };
    ...
    ProtocolDataUnitItem & add(std::string const & name, Field const & field);
     ...
     * contain a sequence of items.
     */
    std::vector<ProtocolDataUnitItem> & as_items(std::string const & name);
