...
Tag const ConfocalMode(0x0048, 0x0114);
Tag const TissueLocation(0x0048, 0x0115);
Tag const ConfocalMicroscopyImageFrameTypeSequence(0x0048, 0x0116);
Tag const ImageAcquisitionDepth(0x0048, 0x0117);
