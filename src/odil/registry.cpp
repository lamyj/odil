...
ElementsDictionary create_public_dictionary()
{
    ...
    RawElementsDictionaryEntry raw_entries[] = {
        ...
        { Tag(0x0008, 0x0063),
          "Anatomic Regions in Study Code Sequence", "AnatomicRegionsInStudyCodeSequence",  "SQ", "1" },
        { Tag(0x0008, 0x0064),
        ...
        { Tag(0x0008, 0x0109),
          "Coding Scheme Resources Sequence", "CodingSchemeResourcesSequence",  "SQ", "1" },
        { Tag(0x0008, 0x010a),
          "Coding Scheme URL Type", "CodingSchemeURLType",  "CS", "1" },
        { Tag(0x0008, 0x010b),
        ...
        { Tag(0x0008, 0x010e),
          "Coding Scheme URL", "CodingSchemeURL",  "UR", "1" },
        { Tag(0x0008, 0x010f),
        ...
        { Tag(0x0008, 0x1156),
          "Definition Source Sequence", "DefinitionSourceSequence",  "SQ", "1" },
        { Tag(0x0008, 0x115a),
        ...
        { Tag(0x0012, 0x0052),
          "Longitudinal Temporal Offset from Event", "LongitudinalTemporalOffsetFromEvent",  "FD", "1" },
        { Tag(0x0012, 0x0053),
          "Longitudinal Temporal Event Type", "LongitudinalTemporalEventType",  "CS", "1" },
        { Tag(0x0012, 0x0060),
        ...
        { Tag(0x0018, 0x11a3),
          "Compression Pressure", "CompressionPressure",  "DS", "1" },
        { Tag(0x0018, 0x11a4),
          "Paddle Description", "PaddleDescription",  "LO", "1" },
        { Tag(0x0018, 0x11a5),
          "Compression Contact Area", "CompressionContactArea",  "DS", "1" },
        { Tag(0x0018, 0x1200),
        ...
        { Tag(0x0022, 0x1612),
          "Derivation Algorithm Sequence", "DerivationAlgorithmSequence",  "SQ", "1" },
        { Tag(0x0022, 0x1615),
          "Ophthalmic Image Type Code Sequence", "OphthalmicImageTypeCodeSequence",  "SQ", "1" },
        { Tag(0x0022, 0x1616),
          "Ophthalmic Image Type Description", "OphthalmicImageTypeDescription",  "LO", "1" },
        { Tag(0x0022, 0x1618),
          "Scan Pattern Type Code Sequence", "ScanPatternTypeCodeSequence",  "SQ", "1" },
        { Tag(0x0022, 0x1620),
          "Referenced Surface Mesh Identification Sequence", "ReferencedSurfaceMeshIdentificationSequence",  "SQ", "1" },
        { Tag(0x0022, 0x1622),
          "Ophthalmic Volumetric Properties Flag", "OphthalmicVolumetricPropertiesFlag",  "CS", "1" },
        { Tag(0x0022, 0x1624),
          "Ophthalmic Anatomic Reference Point X-Coordinate", "OphthalmicAnatomicReferencePointXCoordinate",  "FL", "1" },
        { Tag(0x0022, 0x1626),
          "Ophthalmic Anatomic Reference Point Y-Coordinate", "OphthalmicAnatomicReferencePointYCoordinate",  "FL", "1" },
        { Tag(0x0022, 0x1628),
          "Ophthalmic En Face Image Quality Rating Sequence", "OphthalmicEnFaceImageQualityRatingSequence",  "SQ", "1" },
        { Tag(0x0022, 0x1630),
          "Quality Threshold", "QualityThreshold",  "DS", "1" },
        { Tag(0x0022, 0x1640),
          "OCT B-scan Analysis Acquisition Parameters Sequence", "OCTBscanAnalysisAcquisitionParametersSequence",  "SQ", "1" },
        { Tag(0x0022, 0x1642),
          "Number of B-scans Per Frame", "NumberofBscansPerFrame",  "UL", "1" },
        { Tag(0x0022, 0x1643),
          "B-scan Slab Thickness", "BscanSlabThickness",  "FL", "1" },
        { Tag(0x0022, 0x1644),
          "Distance Between B-scan Slabs", "DistanceBetweenBscanSlabs",  "FL", "1" },
        { Tag(0x0022, 0x1645),
          "B-scan Cycle Time", "BscanCycleTime",  "FL", "1" },
        { Tag(0x0022, 0x1646),
          "B-scan Cycle Time Vector", "BscanCycleTimeVector",  "FL", "1-n" },
        { Tag(0x0022, 0x1649),
          "A-scan Rate", "AscanRate",  "FL", "1" },
        { Tag(0x0022, 0x1650),
          "B-scan Rate", "BscanRate",  "FL", "1" },
        { Tag(0x0022, 0x1658),
          "Surface Mesh Z-Pixel Offset", "SurfaceMeshZPixelOffset",  "UL", "1" },
        { Tag(0x0024, 0x0010),
        ...
        { Tag(0x0040, 0x0710),
          "Whole Slide Microscopy Image Frame Type Sequence", "WholeSlideMicroscopyImageFrameTypeSequence",  "SQ", "1" },
        { Tag(0x0040, 0x071a),
        ...
        { Tag(0x0040, 0x4008),
          "Scheduled Procedure Step Expiration DateTime", "ScheduledProcedureStepExpirationDateTime",  "DT", "1" },
        { Tag(0x0040, 0x4009),
        ...
        { Tag(0x0040, 0x8303),
          "Entrance Dose Derivation", "EntranceDoseDerivation",  "CS", "1" },
        { Tag(0x0040, 0x9092),
        ...
        { Tag(0x0044, 0x0100),
          "Approval Sequence", "ApprovalSequence",  "SQ", "1" },
        { Tag(0x0044, 0x0101),
          "Assertion Code Sequence", "AssertionCodeSequence",  "SQ", "1" },
        { Tag(0x0044, 0x0102),
          "Assertion UID", "AssertionUID",  "UI", "1" },
        { Tag(0x0044, 0x0103),
          "Asserter Identification Sequence", "AsserterIdentificationSequence",  "SQ", "1" },
        { Tag(0x0044, 0x0104),
          "Assertion DateTime", "AssertionDateTime",  "DT", "1" },
        { Tag(0x0044, 0x0105),
          "Assertion Expiration DateTime", "AssertionExpirationDateTime",  "DT", "1" },
        { Tag(0x0044, 0x0106),
          "Assertion Comments", "AssertionComments",  "UT", "1" },
        { Tag(0x0044, 0x0107),
          "Related Assertion Sequence", "RelatedAssertionSequence",  "SQ", "1" },
        { Tag(0x0044, 0x0108),
          "Referenced Assertion UID", "ReferencedAssertionUID",  "UI", "1" },
        { Tag(0x0044, 0x0109),
          "Approval Subject Sequence", "ApprovalSubjectSequence",  "SQ", "1" },
        { Tag(0x0044, 0x010a),
          "Organizational Role Code Sequence", "OrganizationalRoleCodeSequence",  "SQ", "1" },
        { Tag(0x0046, 0x0012),
        ...
        { Tag(0x0048, 0x0302),
          "Number of Optical Paths", "NumberOfOpticalPaths",  "UL", "1" },
        { Tag(0x0048, 0x0303),
          "Total Pixel Matrix Focal Planes", "TotalPixelMatrixFocalPlanes",  "UL", "1" },
        { Tag(0x0050, 0x0004),
        ...
        { Tag(0x0068, 0x7001),
          "Model Modification", "ModelModification",  "CS", "1" },
        { Tag(0x0068, 0x7002),
          "Model Mirroring", "ModelMirroring",  "CS", "1" },
        { Tag(0x0068, 0x7003),
          "Model Usage Code Sequence", "ModelUsageCodeSequence",  "SQ", "1" },
        { Tag(0x0070, 0x0001),
        ...
        { Tag(0x0070, 0x031b),
          "Referenced Fiducial UID", "ReferencedFiducialUID",  "UI", "1" },
        { Tag(0x0070, 0x031c),
        ...
        { Tag(0x0070, 0x1209),
          "Volumetric Presentation Input Set UID", "VolumetricPresentationInputSetUID",  "UI", "1" },
        { Tag(0x0070, 0x120a),
          "Volumetric Presentation Input Set Sequence", "VolumetricPresentationInputSetSequence",  "SQ", "1" },
        { Tag(0x0070, 0x120b),
          "Global Crop", "GlobalCrop",  "CS", "1" },
        { Tag(0x0070, 0x120c),
          "Global Cropping Specification Index", "GlobalCroppingSpecificationIndex",  "US", "1-n" },
        { Tag(0x0070, 0x120d),
          "Rendering Method", "RenderingMethod",  "CS", "1" },
        { Tag(0x0070, 0x1301),
        ...
        { Tag(0x0070, 0x1602),
          "Render Projection", "RenderProjection",  "CS", "1" },
        { Tag(0x0070, 0x1603),
          "Viewpoint Position", "ViewpointPosition",  "FD", "3" },
        { Tag(0x0070, 0x1604),
          "Viewpoint LookAt Point", "ViewpointLookAtPoint",  "FD", "3" },
        { Tag(0x0070, 0x1605),
          "Viewpoint Up Direction", "ViewpointUpDirection",  "FD", "3" },
        { Tag(0x0070, 0x1606),
          "Render Field of View", "RenderFieldOfView",  "FD", "6" },
        { Tag(0x0070, 0x1607),
          "Sampling Step Size", "SamplingStepSize",  "FD", "1" },
        { Tag(0x0070, 0x1701),
          "Shading Style", "ShadingStyle",  "CS", "1" },
        { Tag(0x0070, 0x1702),
          "Ambient Reflection Intensity", "AmbientReflectionIntensity",  "FD", "1" },
        { Tag(0x0070, 0x1703),
          "Light Direction", "LightDirection",  "FD", "3" },
        { Tag(0x0070, 0x1704),
          "Diffuse Reflection Intensity", "DiffuseReflectionIntensity",  "FD", "1" },
        { Tag(0x0070, 0x1705),
          "Specular Reflection Intensity", "SpecularReflectionIntensity",  "FD", "1" },
        { Tag(0x0070, 0x1706),
          "Shininess", "Shininess",  "FD", "1" },
        { Tag(0x0070, 0x1801),
        ...
        { Tag(0x0070, 0x1a06),
          "Swivel Range", "SwivelRange",  "FD", "1" },
        { Tag(0x0070, 0x1a07),
          "Volumetric Curve Up Directions", "VolumetricCurveUpDirections",  "OD", "1" },
        { Tag(0x0070, 0x1a08),
          "Volume Stream Sequence", "VolumeStreamSequence",  "SQ", "1" },
        { Tag(0x0070, 0x1a09),
          "RGBA Transfer Function Description", "RGBATransferFunctionDescription",  "LO", "1" },
        { Tag(0x0070, 0x1b01),
          "Advanced Blending Sequence", "AdvancedBlendingSequence",  "SQ", "1" },
        { Tag(0x0070, 0x1b02),
          "Blending Input Number", "BlendingInputNumber",  "US", "1" },
        { Tag(0x0070, 0x1b03),
          "Blending Display Input Sequence", "BlendingDisplayInputSequence",  "SQ", "1" },
        { Tag(0x0070, 0x1b04),
          "Blending Display Sequence", "BlendingDisplaySequence",  "SQ", "1" },
        { Tag(0x0070, 0x1b06),
          "Blending Mode", "BlendingMode",  "CS", "1" },
        { Tag(0x0070, 0x1b07),
          "Time Series Blending", "TimeSeriesBlending",  "CS", "1" },
        { Tag(0x0070, 0x1b08),
          "Geometry for Display", "GeometryForDisplay",  "CS", "1" },
        { Tag(0x0070, 0x1b11),
          "Threshold Sequence", "ThresholdSequence",  "SQ", "1" },
        { Tag(0x0070, 0x1b12),
          "Threshold Value Sequence", "ThresholdValueSequence",  "SQ", "1" },
        { Tag(0x0070, 0x1b13),
          "Threshold Type", "ThresholdType",  "CS", "1" },
        { Tag(0x0070, 0x1b14),
          "Threshold Value", "ThresholdValue",  "FD", "1" },
        { Tag(0x0072, 0x0002),
        ...
        { Tag(0x0074, 0x1007),
          "Procedure Step Progress Parameters Sequence", "ProcedureStepProgressParametersSequence",  "SQ", "1" },
        { Tag(0x0074, 0x1008),
        ...
        { Tag(0x0080, 0x0010),
          "U Value Data", "UValueData",  "OF", "1" },
        { Tag(0x0080, 0x0011),
          "V Value Data", "VValueData",  "OF", "1" },
        { Tag(0x0080, 0x0012),
        ...
        { Tag(0x0082, 0x000c),
          "Structured Constraint Observation Sequence", "StructuredConstraintObservationSequence",  "SQ", "1" },
        { Tag(0x0082, 0x0010),
        ...
        { Tag(0x300a, 0x0083),
          "Referenced Dose Reference UID", "ReferencedDoseReferenceUID",  "UI", "1" },
        { Tag(0x300a, 0x0084),
        ...
        { Tag(0x300a, 0x0093),
          "Depth Value Averaging Flag", "DepthValueAveragingFlag",  "CS", "1" },
        { Tag(0x300a, 0x00a0),
        ...
        { Tag(0x300a, 0x0271),
          "Channel Effective Length", "ChannelEffectiveLength",  "DS", "1" },
        { Tag(0x300a, 0x0272),
          "Channel Inner Length", "ChannelInnerLength",  "DS", "1" },
        { Tag(0x300a, 0x0273),
          "Afterloader Channel ID", "AfterloaderChannelID",  "SH", "1" },
        { Tag(0x300a, 0x0274),
          "Source Applicator Tip Length", "SourceApplicatorTipLength",  "DS", "1" },
        { Tag(0x300a, 0x0280),
...
std::map<std::string, odil::Tag> create_public_tags()
{
    ...
    { Tag(0x0000, 0x0000),
          ...
          "SOP Classes in Study", "SOPClassesInStudy",  "UI", "1-n" },    { Tag(0x0008, 0x0063),
          "Anatomic Regions in Study Code Sequence", "AnatomicRegionsInStudyCodeSequence",  "SQ", "1" },    { Tag(0x0008, 0x0064),
          ...
          "Extended Code Meaning", "ExtendedCodeMeaning",  "LT", "1" },    { Tag(0x0008, 0x0109),
          "Coding Scheme Resources Sequence", "CodingSchemeResourcesSequence",  "SQ", "1" },    { Tag(0x0008, 0x010a),
          "Coding Scheme URL Type", "CodingSchemeURLType",  "CS", "1" },    { Tag(0x0008, 0x010b),
          ...
          "Context Group Extension Creator UID", "ContextGroupExtensionCreatorUID",  "UI", "1" },    { Tag(0x0008, 0x010e),
          "Coding Scheme URL", "CodingSchemeURL",  "UR", "1" },    { Tag(0x0008, 0x010f),
          ...
          "Referenced SOP Instance UID", "ReferencedSOPInstanceUID",  "UI", "1" },    { Tag(0x0008, 0x1156),
          "Definition Source Sequence", "DefinitionSourceSequence",  "SQ", "1" },    { Tag(0x0008, 0x115a),
          ...
          "Clinical Trial Time Point Description", "ClinicalTrialTimePointDescription",  "ST", "1" },    { Tag(0x0012, 0x0052),
          "Longitudinal Temporal Offset from Event", "LongitudinalTemporalOffsetFromEvent",  "FD", "1" },    { Tag(0x0012, 0x0053),
          "Longitudinal Temporal Event Type", "LongitudinalTemporalEventType",  "CS", "1" },    { Tag(0x0012, 0x0060),
          ...
          "Compression Force", "CompressionForce",  "DS", "1" },    { Tag(0x0018, 0x11a3),
          "Compression Pressure", "CompressionPressure",  "DS", "1" },    { Tag(0x0018, 0x11a4),
          "Paddle Description", "PaddleDescription",  "LO", "1" },    { Tag(0x0018, 0x11a5),
          "Compression Contact Area", "CompressionContactArea",  "DS", "1" },    { Tag(0x0018, 0x1200),
          ...
          "Two Dimensional to Three Dimensional Map Data", "TwoDimensionalToThreeDimensionalMapData",  "OF", "1" },    { Tag(0x0022, 0x1612),
          "Derivation Algorithm Sequence", "DerivationAlgorithmSequence",  "SQ", "1" },    { Tag(0x0022, 0x1615),
          "Ophthalmic Image Type Code Sequence", "OphthalmicImageTypeCodeSequence",  "SQ", "1" },    { Tag(0x0022, 0x1616),
          "Ophthalmic Image Type Description", "OphthalmicImageTypeDescription",  "LO", "1" },    { Tag(0x0022, 0x1618),
          "Scan Pattern Type Code Sequence", "ScanPatternTypeCodeSequence",  "SQ", "1" },    { Tag(0x0022, 0x1620),
          "Referenced Surface Mesh Identification Sequence", "ReferencedSurfaceMeshIdentificationSequence",  "SQ", "1" },    { Tag(0x0022, 0x1622),
          "Ophthalmic Volumetric Properties Flag", "OphthalmicVolumetricPropertiesFlag",  "CS", "1" },    { Tag(0x0022, 0x1624),
          "Ophthalmic Anatomic Reference Point X-Coordinate", "OphthalmicAnatomicReferencePointXCoordinate",  "FL", "1" },    { Tag(0x0022, 0x1626),
          "Ophthalmic Anatomic Reference Point Y-Coordinate", "OphthalmicAnatomicReferencePointYCoordinate",  "FL", "1" },    { Tag(0x0022, 0x1628),
          "Ophthalmic En Face Image Quality Rating Sequence", "OphthalmicEnFaceImageQualityRatingSequence",  "SQ", "1" },    { Tag(0x0022, 0x1630),
          "Quality Threshold", "QualityThreshold",  "DS", "1" },    { Tag(0x0022, 0x1640),
          "OCT B-scan Analysis Acquisition Parameters Sequence", "OCTBscanAnalysisAcquisitionParametersSequence",  "SQ", "1" },    { Tag(0x0022, 0x1642),
          "Number of B-scans Per Frame", "NumberofBscansPerFrame",  "UL", "1" },    { Tag(0x0022, 0x1643),
          "B-scan Slab Thickness", "BscanSlabThickness",  "FL", "1" },    { Tag(0x0022, 0x1644),
          "Distance Between B-scan Slabs", "DistanceBetweenBscanSlabs",  "FL", "1" },    { Tag(0x0022, 0x1645),
          "B-scan Cycle Time", "BscanCycleTime",  "FL", "1" },    { Tag(0x0022, 0x1646),
          "B-scan Cycle Time Vector", "BscanCycleTimeVector",  "FL", "1-n" },    { Tag(0x0022, 0x1649),
          "A-scan Rate", "AscanRate",  "FL", "1" },    { Tag(0x0022, 0x1650),
          "B-scan Rate", "BscanRate",  "FL", "1" },    { Tag(0x0022, 0x1658),
          "Surface Mesh Z-Pixel Offset", "SurfaceMeshZPixelOffset",  "UL", "1" },    { Tag(0x0024, 0x0010),
          ...
          "Slide Identifier", "SlideIdentifier",  "LO", "1" },    { Tag(0x0040, 0x0710),
          "Whole Slide Microscopy Image Frame Type Sequence", "WholeSlideMicroscopyImageFrameTypeSequence",  "SQ", "1" },    { Tag(0x0040, 0x071a),
          ...
          "Performed Processing Applications Code Sequence", "PerformedProcessingApplicationsCodeSequence",  "SQ", "1" },    { Tag(0x0040, 0x4008),
          "Scheduled Procedure Step Expiration DateTime", "ScheduledProcedureStepExpirationDateTime",  "DT", "1" },    { Tag(0x0040, 0x4009),
          ...
          "Entrance Dose in mGy", "EntranceDoseInmGy",  "DS", "1" },    { Tag(0x0040, 0x8303),
          "Entrance Dose Derivation", "EntranceDoseDerivation",  "CS", "1" },    { Tag(0x0040, 0x9092),
          ...
          "Substance Administration Parameter Sequence", "SubstanceAdministrationParameterSequence",  "SQ", "1" },    { Tag(0x0044, 0x0100),
          "Approval Sequence", "ApprovalSequence",  "SQ", "1" },    { Tag(0x0044, 0x0101),
          "Assertion Code Sequence", "AssertionCodeSequence",  "SQ", "1" },    { Tag(0x0044, 0x0102),
          "Assertion UID", "AssertionUID",  "UI", "1" },    { Tag(0x0044, 0x0103),
          "Asserter Identification Sequence", "AsserterIdentificationSequence",  "SQ", "1" },    { Tag(0x0044, 0x0104),
          "Assertion DateTime", "AssertionDateTime",  "DT", "1" },    { Tag(0x0044, 0x0105),
          "Assertion Expiration DateTime", "AssertionExpirationDateTime",  "DT", "1" },    { Tag(0x0044, 0x0106),
          "Assertion Comments", "AssertionComments",  "UT", "1" },    { Tag(0x0044, 0x0107),
          "Related Assertion Sequence", "RelatedAssertionSequence",  "SQ", "1" },    { Tag(0x0044, 0x0108),
          "Referenced Assertion UID", "ReferencedAssertionUID",  "UI", "1" },    { Tag(0x0044, 0x0109),
          "Approval Subject Sequence", "ApprovalSubjectSequence",  "SQ", "1" },    { Tag(0x0044, 0x010a),
          "Organizational Role Code Sequence", "OrganizationalRoleCodeSequence",  "SQ", "1" },    { Tag(0x0046, 0x0012),
          ...
          "Pixel Origin Interpretation", "PixelOriginInterpretation",  "CS", "1" },    { Tag(0x0048, 0x0302),
          "Number of Optical Paths", "NumberOfOpticalPaths",  "UL", "1" },    { Tag(0x0048, 0x0303),
          "Total Pixel Matrix Focal Planes", "TotalPixelMatrixFocalPlanes",  "UL", "1" },    { Tag(0x0050, 0x0004),
          ...
          "3D Plane Normal", "ThreeDPlaneNormal",  "FD", "3" },    { Tag(0x0068, 0x7001),
          "Model Modification", "ModelModification",  "CS", "1" },    { Tag(0x0068, 0x7002),
          "Model Mirroring", "ModelMirroring",  "CS", "1" },    { Tag(0x0068, 0x7003),
          "Model Usage Code Sequence", "ModelUsageCodeSequence",  "SQ", "1" },    { Tag(0x0070, 0x0001),
          ...
          "Fiducial UID", "FiducialUID",  "UI", "1" },    { Tag(0x0070, 0x031b),
          "Referenced Fiducial UID", "ReferencedFiducialUID",  "UI", "1" },    { Tag(0x0070, 0x031c),
          ...
          "Image Volume Geometry", "ImageVolumeGeometry",  "CS", "1" },    { Tag(0x0070, 0x1209),
          "Volumetric Presentation Input Set UID", "VolumetricPresentationInputSetUID",  "UI", "1" },    { Tag(0x0070, 0x120a),
          "Volumetric Presentation Input Set Sequence", "VolumetricPresentationInputSetSequence",  "SQ", "1" },    { Tag(0x0070, 0x120b),
          "Global Crop", "GlobalCrop",  "CS", "1" },    { Tag(0x0070, 0x120c),
          "Global Cropping Specification Index", "GlobalCroppingSpecificationIndex",  "US", "1-n" },    { Tag(0x0070, 0x120d),
          "Rendering Method", "RenderingMethod",  "CS", "1" },    { Tag(0x0070, 0x1301),
          ...
          "MPR View Height", "MPRViewHeight",  "FD", "1" },    { Tag(0x0070, 0x1602),
          "Render Projection", "RenderProjection",  "CS", "1" },    { Tag(0x0070, 0x1603),
          "Viewpoint Position", "ViewpointPosition",  "FD", "3" },    { Tag(0x0070, 0x1604),
          "Viewpoint LookAt Point", "ViewpointLookAtPoint",  "FD", "3" },    { Tag(0x0070, 0x1605),
          "Viewpoint Up Direction", "ViewpointUpDirection",  "FD", "3" },    { Tag(0x0070, 0x1606),
          "Render Field of View", "RenderFieldOfView",  "FD", "6" },    { Tag(0x0070, 0x1607),
          "Sampling Step Size", "SamplingStepSize",  "FD", "1" },    { Tag(0x0070, 0x1701),
          "Shading Style", "ShadingStyle",  "CS", "1" },    { Tag(0x0070, 0x1702),
          "Ambient Reflection Intensity", "AmbientReflectionIntensity",  "FD", "1" },    { Tag(0x0070, 0x1703),
          "Light Direction", "LightDirection",  "FD", "3" },    { Tag(0x0070, 0x1704),
          "Diffuse Reflection Intensity", "DiffuseReflectionIntensity",  "FD", "1" },    { Tag(0x0070, 0x1705),
          "Specular Reflection Intensity", "SpecularReflectionIntensity",  "FD", "1" },    { Tag(0x0070, 0x1706),
          "Shininess", "Shininess",  "FD", "1" },    { Tag(0x0070, 0x1801),
          ...
          "Animation Step Size", "AnimationStepSize",  "FD", "1" },    { Tag(0x0070, 0x1a06),
          "Swivel Range", "SwivelRange",  "FD", "1" },    { Tag(0x0070, 0x1a07),
          "Volumetric Curve Up Directions", "VolumetricCurveUpDirections",  "OD", "1" },    { Tag(0x0070, 0x1a08),
          "Volume Stream Sequence", "VolumeStreamSequence",  "SQ", "1" },    { Tag(0x0070, 0x1a09),
          "RGBA Transfer Function Description", "RGBATransferFunctionDescription",  "LO", "1" },    { Tag(0x0070, 0x1b01),
          "Advanced Blending Sequence", "AdvancedBlendingSequence",  "SQ", "1" },    { Tag(0x0070, 0x1b02),
          "Blending Input Number", "BlendingInputNumber",  "US", "1" },    { Tag(0x0070, 0x1b03),
          "Blending Display Input Sequence", "BlendingDisplayInputSequence",  "SQ", "1" },    { Tag(0x0070, 0x1b04),
          "Blending Display Sequence", "BlendingDisplaySequence",  "SQ", "1" },    { Tag(0x0070, 0x1b06),
          "Blending Mode", "BlendingMode",  "CS", "1" },    { Tag(0x0070, 0x1b07),
          "Time Series Blending", "TimeSeriesBlending",  "CS", "1" },    { Tag(0x0070, 0x1b08),
          "Geometry for Display", "GeometryForDisplay",  "CS", "1" },    { Tag(0x0070, 0x1b11),
          "Threshold Sequence", "ThresholdSequence",  "SQ", "1" },    { Tag(0x0070, 0x1b12),
          "Threshold Value Sequence", "ThresholdValueSequence",  "SQ", "1" },    { Tag(0x0070, 0x1b13),
          "Threshold Type", "ThresholdType",  "CS", "1" },    { Tag(0x0070, 0x1b14),
          "Threshold Value", "ThresholdValue",  "FD", "1" },    { Tag(0x0072, 0x0002),
          ...
          "Procedure Step Progress Description", "ProcedureStepProgressDescription",  "ST", "1" },    { Tag(0x0074, 0x1007),
          "Procedure Step Progress Parameters Sequence", "ProcedureStepProgressParametersSequence",  "SQ", "1" },    { Tag(0x0074, 0x1008),
          ...
          "U Value Data", "UValueData",  "OF", "1" },    { Tag(0x0080, 0x0011),
          "V Value Data", "VValueData",  "OF", "1" },    { Tag(0x0080, 0x0012),
          ...
          "Structured Constraint Observation Sequence", "StructuredConstraintObservationSequence",  "SQ", "1" },    { Tag(0x0082, 0x0010),
          ...
          "Beam Dose Specification Point", "BeamDoseSpecificationPoint",  "DS", "3" },    { Tag(0x300a, 0x0083),
          "Referenced Dose Reference UID", "ReferencedDoseReferenceUID",  "UI", "1" },    { Tag(0x300a, 0x0084),
          ...
          "Alternate Beam Dose Type", "AlternateBeamDoseType",  "CS", "1" },    { Tag(0x300a, 0x0093),
          "Depth Value Averaging Flag", "DepthValueAveragingFlag",  "CS", "1" },    { Tag(0x300a, 0x00a0),
          ...
          "Brachy Accessory Device Nominal Transmission", "BrachyAccessoryDeviceNominalTransmission",  "DS", "1" },    { Tag(0x300a, 0x0271),
          "Channel Effective Length", "ChannelEffectiveLength",  "DS", "1" },    { Tag(0x300a, 0x0272),
          "Channel Inner Length", "ChannelInnerLength",  "DS", "1" },    { Tag(0x300a, 0x0273),
          "Afterloader Channel ID", "AfterloaderChannelID",  "SH", "1" },    { Tag(0x300a, 0x0274),
          "Source Applicator Tip Length", "SourceApplicatorTipLength",  "DS", "1" },    { Tag(0x300a, 0x0280),
...
UIDsDictionary create_uids_dictionary()
{
    ...
    RawUIDsDictionaryEntry raw_entries[] = {
        ...
        { "1.2.840.10008.5.1.4.1.1.11.1", "Grayscale Softcopy Presentation State Storage", "GrayscaleSoftcopyPresentationStateStorage",  "SOP Class" },
        { "1.2.840.10008.5.1.4.1.1.11.2", "Color Softcopy Presentation State Storage", "ColorSoftcopyPresentationStateStorage",  "SOP Class" },
        { "1.2.840.10008.5.1.4.1.1.11.3", "Pseudo-Color Softcopy Presentation State Storage", "PseudoColorSoftcopyPresentationStateStorage",  "SOP Class" },
        { "1.2.840.10008.5.1.4.1.1.11.4", "Blending Softcopy Presentation State Storage", "BlendingSoftcopyPresentationStateStorage",  "SOP Class" },
        ...
        { "1.2.840.10008.5.1.4.1.1.11.8", "Advanced Blending Presentation State Storage", "AdvancedBlendingPresentationStateStorage",  "SOP Class" },
        { "1.2.840.10008.5.1.4.1.1.11.9", "Volume Rendering Volumetric Presentation State Storage", "VolumeRenderingVolumetricPresentationStateStorage",  "SOP Class" },
        { "1.2.840.10008.5.1.4.1.1.11.10", "Segmented Volume Rendering Volumetric Presentation State Storage", "SegmentedVolumeRenderingVolumetricPresentationStateStorage",  "SOP Class" },
        { "1.2.840.10008.5.1.4.1.1.11.11", "Multiple Volume Rendering Volumetric Presentation State Storage", "MultipleVolumeRenderingVolumetricPresentationStateStorage",  "SOP Class" },
        ...
        { "1.2.840.10008.5.1.4.1.1.77.1.5.7", "Ophthalmic Optical Coherence Tomography En Face Image Storage", "OphthalmicOpticalCoherenceTomographyEnFaceImageStorage",  "SOP Class" },
        { "1.2.840.10008.5.1.4.1.1.77.1.5.8", "Ophthalmic Optical Coherence Tomography B-scan Volume Analysis Storage", "OphthalmicOpticalCoherenceTomographyBscanVolumeAnalysisStorage",  "SOP Class" },
        ...
        { "1.2.840.10008.5.1.4.1.1.88.73", "Patient Radiation Dose SR Storage", "PatientRadiationDoseSRStorage",  "SOP Class" },
        ...
        { "1.2.840.10008.5.1.4.1.1.104.3", "Encapsulated STL Storage", "EncapsulatedSTLStorage",  "SOP Class" },
        ...
        { "1.2.840.10008.5.1.4.1.1.200.3", "Protocol Approval Storage", "ProtocolApprovalStorage",  "SOP Class" },
        { "1.2.840.10008.5.1.4.1.1.200.4", "Protocol Approval Information Model - FIND", "ProtocolApprovalInformationModelFIND",  "SOP Class" },
        { "1.2.840.10008.5.1.4.1.1.200.5", "Protocol Approval Information Model - MOVE", "ProtocolApprovalInformationModelMOVE",  "SOP Class" },
        { "1.2.840.10008.5.1.4.1.1.200.6", "Protocol Approval Information Model - GET", "ProtocolApprovalInformationModelGET",  "SOP Class" },
        ...
        { "1.2.840.10008.5.1.4.39.1", "Color Palette Storage", "ColorPaletteStorage",  "SOP Class" },
