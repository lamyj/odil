...
Tag const DataElementLabelSequence(0x0014, 0x0200);
Tag const DataElementLabelItemSequence(0x0014, 0x0201);
Tag const DataElement(0x0014, 0x0202);
Tag const DataElementName(0x0014, 0x0203);
Tag const DataElementDescription(0x0014, 0x0204);
Tag const DataElementConditionality(0x0014, 0x0205);
Tag const DataElementMinimumCharacters(0x0014, 0x0206);
Tag const DataElementMaximumCharacters(0x0014, 0x0207);
