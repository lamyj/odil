...
Tag const EnhancedRTBeamLimitingDeviceSequence(0x3008, 0x00a1);
Tag const EnhancedRTBeamLimitingOpeningSequence(0x3008, 0x00a2);
Tag const EnhancedRTBeamLimitingDeviceDefinitionFlag(0x3008, 0x00a3);
Tag const ParallelRTBeamDelimiterOpeningExtents(0x3008, 0x00a4);
