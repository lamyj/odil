...
Tag const ScopeOfInventorySequence(0x0008, 0x0400);
Tag const InventoryPurpose(0x0008, 0x0401);
Tag const InventoryInstanceDescription(0x0008, 0x0402);
Tag const InventoryLevel(0x0008, 0x0403);
Tag const ItemInventoryDateTime(0x0008, 0x0404);
Tag const RemovedFromOperationalUse(0x0008, 0x0405);
Tag const ReasonForRemovalCodeSequence(0x0008, 0x0406);
Tag const StoredInstanceBaseURI(0x0008, 0x0407);
Tag const FolderAccessURI(0x0008, 0x0408);
Tag const FileAccessURI(0x0008, 0x0409);
Tag const ContainerFileType(0x0008, 0x040a);
Tag const FilenameInContainer(0x0008, 0x040b);
Tag const FileOffsetInContainer(0x0008, 0x040c);
Tag const FileLengthInContainer(0x0008, 0x040d);
Tag const StoredInstanceTransferSyntaxUID(0x0008, 0x040e);
Tag const ExtendedMatchingMechanisms(0x0008, 0x040f);
Tag const RangeMatchingSequence(0x0008, 0x0410);
Tag const ListOfUIDMatchingSequence(0x0008, 0x0411);
Tag const EmptyValueMatchingSequence(0x0008, 0x0412);
Tag const GeneralMatchingSequence(0x0008, 0x0413);
Tag const RequestedStatusInterval(0x0008, 0x0414);
Tag const RetainInstances(0x0008, 0x0415);
Tag const ExpirationDateTime(0x0008, 0x0416);
Tag const TransactionStatus(0x0008, 0x0417);
Tag const TransactionStatusComment(0x0008, 0x0418);
Tag const FileSetAccessSequence(0x0008, 0x0419);
Tag const FileAccessSequence(0x0008, 0x041a);
Tag const RecordKey(0x0008, 0x041b);
Tag const PriorRecordKey(0x0008, 0x041c);
Tag const MetadataSequence(0x0008, 0x041d);
Tag const UpdatedMetadataSequence(0x0008, 0x041e);
Tag const StudyUpdateDateTime(0x0008, 0x041f);
Tag const InventoryAccessEndPointsSequence(0x0008, 0x0420);
Tag const StudyAccessEndPointsSequence(0x0008, 0x0421);
Tag const IncorporatedInventoryInstanceSequence(0x0008, 0x0422);
Tag const InventoriedStudiesSequence(0x0008, 0x0423);
Tag const InventoriedSeriesSequence(0x0008, 0x0424);
Tag const InventoriedInstancesSequence(0x0008, 0x0425);
Tag const InventoryCompletionStatus(0x0008, 0x0426);
Tag const NumberOfStudyRecordsInInstance(0x0008, 0x0427);
Tag const TotalNumberOfStudyRecords(0x0008, 0x0428);
Tag const MaximumNumberOfRecords(0x0008, 0x0429);
...
Tag const ReferencedInstancesBySOPClassSequence(0x0008, 0x1112);
...
Tag const FailedStudySequence(0x0008, 0x119b);
