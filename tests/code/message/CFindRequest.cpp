...
struct Fixture: public MessageFixtureBase<dcmtkpp::message::CFindRequest>
{
    ...
    Fixture()
    {
        this->command_set.add(
            "CommandField", {dcmtkpp::message::Message::Command::C_FIND_RQ});
    ...
    virtual void check(dcmtkpp::message::CFindRequest const & message)
    {
        BOOST_CHECK_EQUAL(
...
{
    dcmtkpp::message::CFindRequest const message(
